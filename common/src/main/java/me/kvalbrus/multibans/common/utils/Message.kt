...
enum class Message(val key: String, private var text: String, val description: String) {
    ...
    BAN_DELETE_TARGET("ban.delete.target", "", ""),
    ...
    BAN_REASON_CREATE_CHANGE_EXECUTOR(
        "ban.reason-create.change.executor",
    ...
    TEMPBAN_ACTIVATE_TARGET(
        "tempban.activate.target",
        """
            Temporary ban
    ...
    TEMPBAN_DELETE_TARGET("tempban.delete.target", "", ""),
    TEMPBAN_COMMENT_CHANGE_LISTEN("tempban.comment.change.listen", "", ""),
    TEMPBAN_COMMENT_CHANGE_EXECUTOR(
        "tempban.comment.change.executor",
        "You changed the comment",
        ""
    ),

    TEMPBAN_REASON_CREATE_CHANGE_LISTEN("tempban.reason-create.change.listen", "", ""),
    TEMPBAN_REASON_CREATE_CHANGE_EXECUTOR(
        "tenpban.reason-create.change.executor",
        "You change the reason",
        ""
    ),
    ...
    BANIP_ACTIVATE_TARGET(
        "banip.activate.target",
        """
            Permanently ban
    ...
    BANIP_DELETE_TARGET("banip.delete.target", "", ""),
    ...
    BANIP_REASON_CREATE_CHANGE_EXECUTOR(
        "banip.reason-create.change.executor",
        "You change the reason",
        ""
    ),
    ...
    TEMPBANIP_ACTIVATE_TARGET(
        "tempbanip.activate.target",
        """
            Temporary ban-ip
    ...
    TEMPBANIP_DELETE_TARGET("tempbanip.delete.target", "", ""),
    TEMPBANIP_COMMENT_CHANGE_LISTEN("tempbanip.comment.change.listen", "", ""),
    TEMPBANIP_COMMENT_CHANGE_EXECUTOR(
        "tempbanip.comment.change.executor",
        "You changed the comment",
        ""
    ),

    TEMPBANIP_REASON_CREATE_CHANGE_LISTEN("tempbanip.reason-create.change.listen", "", ""),
    TEMPBANIP_REASON_CREATE_CHANGE_EXECUTOR(
        "tempbanip.reason-create.change.executor",
        "You change the reason",
        ""
    ),
    ...
    MUTECHAT_COMMENT_CHANGE_EXECUTOR(
        "mutechat.comment.change.executor",
        "You changed the comment",
        ""
    ),

    MUTECHAT_REASON_CREATE_CHANGE_LISTEN("mutechat.reason-create.change.listen", "", ""),
    MUTECHAT_REASON_CREATE_CHANGE_EXECUTOR(
        "mutechat.reason-create.change.executor",
        "You change the reason",
        ""
    ),
    ...
    TEMPMUTECHAT_COMMENT_CHANGE_EXECUTOR(
        "tempmutechat.comment.change.executor",
        "You changed the comment",
        ""
    ),

    TEMPMUTECHAT_REASON_CREATE_CHANGE_LISTEN("tempmutechat.reason-create.change.listen", "", ""),
    TEMPMUTECHAT_REASON_CREATE_CHANGE_EXECUTOR(
        "tempmutechat.reason-create.change.executor",
        "You change the reason",
        ""
    ),
