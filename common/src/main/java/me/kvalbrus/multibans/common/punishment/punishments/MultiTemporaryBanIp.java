...
public class MultiTemporaryBanIp extends MultiTemporaryPunishment implements TemporaryBanIp {
    ...
    public String getActivateMessageForListener() {
        return Message.TEMPBANIP_ACTIVATE_LISTEN.getMessage();
    }

    @NotNull
    @Override
    public String getActivateMessageForExecutor() {
        return Message.TEMPBANIP_ACTIVATE_EXECUTOR.getMessage();
    }
    ...
    public String getDeactivateMessageForListener() {
        return Message.TEMPBANIP_DEACTIVATE_LISTEN.getMessage();
    }

    @NotNull
    @Override
    public String getDeactivateMessageForExecutor() {
        return Message.TEMPBANIP_DEACTIVATE_EXECUTOR.getMessage();
    }
    ...
    public String getDeleteMessageForListener() {
        return Message.TEMPBANIP_DELETE_LISTEN.getMessage();
    }

    @NotNull
    @Override
    public String getDeleteMessageForExecutor() {
        return Message.TEMPBANIP_DELETE_EXECUTOR.getMessage();
    }
    ...
    public  String getReasonChangeMessageForExecutor() {
        return Message.TEMPBANIP_REASON_CREATE_CHANGE_EXECUTOR.getMessage();
    }

    @NotNull
    @Override
    public String getReasonChangeMessageForListener() {
        return Message.TEMPBANIP_REASON_CREATE_CHANGE_LISTEN.getMessage();
    }
    ...
    public String getCommentChangeMessageForListener() {
        return Message.TEMPBANIP_COMMENT_CHANGE_EXECUTOR.getMessage();
    }

    @NotNull
    @Override
    public Permission getPermissionForListener() {
        return Permission.PUNISHMENT_TEMPBANIP_LISTEN;
    }
}